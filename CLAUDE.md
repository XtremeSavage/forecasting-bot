...
Project status (2026-09-12): code complete on branch `build/v1`, 58 offline tests green, nothing run live. Autonomy level for this project is C: free rein on code and local files; confirm before spending money, sending messages, or the first submission to a live tournament.
